        ...
        >
          ...
          <td className="pt-1 pb-2 px-3 align-top" style={{ width: '14%' }}>
            <div className="inline-flex items-center justify-center px-1 py-0.5 backdrop-blur-md rounded-full mb-0.5" style={{ backgroundColor: 'var(--badge-bg, #f1f5f9)', boxShadow: '0 0 0 0.5px var(--badge-border, #cbd5e1)' }}>
              <span className="font-medium text-center" style={{ fontSize: '8px', color: 'var(--badge-text, #475569)' }}>동</span>
            </div>
          ...
          <td className="pt-1 pb-2 px-3 align-top text-[16px]" style={{ width: '14%' }}>
            <div className="inline-flex items-center justify-center px-1 py-0.5 backdrop-blur-md rounded-full mb-0.5" style={{ backgroundColor: 'var(--badge-bg, #f1f5f9)', boxShadow: '0 0 0 0.5px var(--badge-border, #cbd5e1)' }}>
              <span className="font-medium text-center" style={{ fontSize: '8px', color: 'var(--badge-text, #475569)' }}>반</span>
            </div>
            <div className="text-gray-600 print:text-black" style={{ fontSize: '10px', lineHeight: '1.4' }}>
              {isEditable ? (
                <EditableText
